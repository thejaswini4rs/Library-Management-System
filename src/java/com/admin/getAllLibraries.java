 ...
 * @author SHIV
 */
@WebServlet(name = "getAllLibraries", urlPatterns = {"/getAllLibraries"})
public class getAllLibraries extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query = "select * from library where isAssign=0";
