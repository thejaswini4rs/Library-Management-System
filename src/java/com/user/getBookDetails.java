...
@WebServlet(name = "getBookDetails", urlPatterns = {"/getBookDetails"})
public class getBookDetails extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            System.out.println("bookid : "+bookid+" libid: "+libid);
            ...
            System.out.println("bookid: "+bookid+" libid: "+libid+" uid: "+uid);
            
            String sql = "select * from books where bkid='"+bookid+"' and qty>0";
